...
export const specNames: Record<Spec, string> = {
	[Spec.SpecBalanceDruid]: t('Balance Druid'),
	[Spec.SpecFeralDruid]: t('Feral DPS Druid'),
	[Spec.SpecFeralTankDruid]: t('Feral Tank Druid'),
	[Spec.SpecRestorationDruid]: t('Restoration Druid'),
	[Spec.SpecElementalShaman]: t('Elemental Shaman'),
	[Spec.SpecEnhancementShaman]: t('Enhancement Shaman'),
	[Spec.SpecRestorationShaman]: t('Restoration Shaman'),
	[Spec.SpecHunter]: t('Hunter'),
	[Spec.SpecMage]: t('Mage'),
	[Spec.SpecRogue]: t('Rogue'),
	[Spec.SpecHolyPaladin]: t('Holy Paladin'),
	[Spec.SpecProtectionPaladin]: t('Protection Paladin'),
	[Spec.SpecRetributionPaladin]: t('Retribution Paladin'),
	[Spec.SpecHealingPriest]: t('Priest'),
	[Spec.SpecShadowPriest]: t('Shadow Priest'),
	[Spec.SpecSmitePriest]: t('Smite Priest'),
	[Spec.SpecWarlock]: t('Warlock'),
	[Spec.SpecWarrior]: t('DPS Warrior'),
	[Spec.SpecProtectionWarrior]: t('Protection Warrior'),
	[Spec.SpecDeathknight]: t('DPS Death Knight'),
	[Spec.SpecTankDeathknight]: t('Tank Death Knight'),
};

export const classNames: Record<Class, string> = {
	[Class.ClassUnknown]: '',
	[Class.ClassDruid]: t('Druid'),
	[Class.ClassHunter]: t('Hunter'),
	[Class.ClassMage]: t('Mage'),
	[Class.ClassPaladin]: t('Paladin'),
	[Class.ClassPriest]: t('Priest'),
	[Class.ClassRogue]: t('Rogue'),
	[Class.ClassShaman]: t('Shaman'),
	[Class.ClassWarlock]: t('Warlock'),
	[Class.ClassWarrior]: t('Warrior'),
	[Class.ClassDeathknight]: t('Death Knight')
}
...
export const raidSimLabel: string = t('Full Raid Sim');
