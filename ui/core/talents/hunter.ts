...
export const hunterGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[HunterMajorGlyph.GlyphOfAimedShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_spear_07.jpg',
		},
		[HunterMajorGlyph.GlyphOfArcaneShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_impalingbolt.jpg',
		},
		[HunterMajorGlyph.GlyphOfAspectOfTheViper]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_aspectoftheviper.jpg',
		},
		[HunterMajorGlyph.GlyphOfBestialWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_ferociousbite.jpg',
		},
		[HunterMajorGlyph.GlyphOfChimeraShot]: {
			name: 'Glyph of Chimera Shot',
			description: 'Reduces the cooldown of Chimera Shot by 1 sec.',
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_chimerashot2.jpg',
		},
		...
		[HunterMajorGlyph.GlyphOfExplosiveShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_explosiveshot.jpg',
		},
		[HunterMajorGlyph.GlyphOfExplosiveTrap]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_selfdestruct.jpg',
		},
		...
		[HunterMajorGlyph.GlyphOfFrostTrap]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_freezingbreath.jpg',
		},
		[HunterMajorGlyph.GlyphOfHuntersMark]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_snipershot.jpg',
		},
		...
		[HunterMajorGlyph.GlyphOfKillShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_assassinate2.jpg',
		},
		[HunterMajorGlyph.GlyphOfMending]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_mendpet.jpg',
		},
		[HunterMajorGlyph.GlyphOfMultiShot]: {
			name: 'Glyph of Multi-Shot',
			description: 'Decreases the cooldown of Multi-Shot by 1 sec.',
			iconUrl: '/wotlk/assets/icons/large/ability_upgrademoonglaive.jpg',
		},
		[HunterMajorGlyph.GlyphOfRapidFire]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_runningshot.jpg',
		},
		...
		[HunterMajorGlyph.GlyphOfScatterShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_golemstormbolt.jpg',
		},
		[HunterMajorGlyph.GlyphOfSerpentSting]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_quickshot.jpg',
		},
		[HunterMajorGlyph.GlyphOfSnakeTrap]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_snaketrap.jpg',
		},
		[HunterMajorGlyph.GlyphOfSteadyShot]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_steadyshot.jpg',
		},
		[HunterMajorGlyph.GlyphOfTheBeast]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mount_pinktiger.jpg',
		},
		[HunterMajorGlyph.GlyphOfTheHawk]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_ravenform.jpg',
		},
		[HunterMajorGlyph.GlyphOfTrueshotAura]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_trueshot.jpg',
		},
		...
		[HunterMajorGlyph.GlyphOfWyvernSting]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_spear_02.jpg',
		},
	},
	minorGlyphs: {
		[HunterMinorGlyph.GlyphOfFeignDeath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_rogue_feigndeath.jpg',
		},
		...
		[HunterMinorGlyph.GlyphOfPossessedStrength]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_eyeoftheowl.jpg',
		},
		[HunterMinorGlyph.GlyphOfRevivePet]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_hunter_beastsoothe.jpg',
		},
		[HunterMinorGlyph.GlyphOfScareBeast]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_cower.jpg',
		},
		[HunterMinorGlyph.GlyphOfThePack]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mount_jungletiger.jpg',
		},
	},
};
