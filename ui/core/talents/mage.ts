...
export const mageGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[MageMajorGlyph.GlyphOfArcaneBarrage]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mage_arcanebarrage.jpg',
		},
		[MageMajorGlyph.GlyphOfArcaneBlast]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_arcane_blast.jpg',
		},
		[MageMajorGlyph.GlyphOfArcaneExplosion]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_wispsplode.jpg',
		},
		...
		[MageMajorGlyph.GlyphOfBlink]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_arcane_blink.jpg',
		},
		[MageMajorGlyph.GlyphOfDeepFreeze]: {
			name: 'Glyph of Deep Freeze',
			description: 'Increases the range of Deep Freeze by 10 yards.',
			iconUrl: '/wotlk/assets/icons/large/ability_mage_deepfreeze.jpg',
		},
		[MageMajorGlyph.GlyphOfEternalWater]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_summonwaterelemental_2.jpg',
		},
		[MageMajorGlyph.GlyphOfEvocation]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_purge.jpg',
		},
		...
		[MageMajorGlyph.GlyphOfFireball]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_flamebolt.jpg',
		},
		[MageMajorGlyph.GlyphOfFrostNova]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostnova.jpg',
		},
		[MageMajorGlyph.GlyphOfFrostbolt]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostbolt02.jpg',
		},
		[MageMajorGlyph.GlyphOfFrostfire]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mage_frostfirebolt.jpg',
		},
		[MageMajorGlyph.GlyphOfIceArmor]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostarmor02.jpg',
		},
		[MageMajorGlyph.GlyphOfIceBarrier]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_ice_lament.jpg',
		},
		[MageMajorGlyph.GlyphOfIceBlock]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frost.jpg',
		},
		[MageMajorGlyph.GlyphOfIceLance]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostblast.jpg',
		},
		[MageMajorGlyph.GlyphOfIcyVeins]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_coldhearted.jpg',
		},
		[MageMajorGlyph.GlyphOfInvisibility]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mage_invisibility.jpg',
		},
		[MageMajorGlyph.GlyphOfLivingBomb]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mage_livingbomb.jpg',
		},
		...
		[MageMajorGlyph.GlyphOfMoltenArmor]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_mage_moltenarmor.jpg',
		},
		[MageMajorGlyph.GlyphOfPolymorph]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_polymorph.jpg',
		},
		[MageMajorGlyph.GlyphOfRemoveCurse]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_removecurse.jpg',
		},
	...
	minorGlyphs: {
		[MageMinorGlyph.GlyphOfArcaneIntellect]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_magicalsentry.jpg',
		},
		[MageMinorGlyph.GlyphOfBlastWave]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_excorcism_02.jpg',
		},
		[MageMinorGlyph.GlyphOfFireWard]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_firearmor.jpg',
		},
		...
		[MageMinorGlyph.GlyphOfFrostWard]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostward.jpg',
		},
		[MageMinorGlyph.GlyphOfSlowFall]: {
			name: 'Glyph of Slow Fall',
			description: 'Your Slow Fall spell no longer requires a reagent.',
			iconUrl: '/wotlk/assets/icons/large/spell_magic_featherfall.jpg',
		},
		[MageMinorGlyph.GlyphOfThePenguin]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_misc_penguinpet.jpg',
		},
	},
};
