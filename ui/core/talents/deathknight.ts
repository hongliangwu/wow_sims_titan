...
export const deathknightGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[DeathknightMajorGlyph.GlyphOfAntiMagicShell]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_antimagicshell.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfBloodStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_deathstrike.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfBoneShield]: {
			name: 'Glyph of Bone Shield',
			description: 'Adds 1 additional charge to your Bone Shield.',
			iconUrl: '/wotlk/assets/icons/large/inv_chest_leather_13.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfChainsOfIce]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_chainsofice.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfDancingRuneWeapon]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_sword_07.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfDarkCommand]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_shamanrage.jpg',
		},
		...
		[DeathknightMajorGlyph.GlyphOfDeathAndDecay]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_deathanddecay.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfDeathGrip]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_strangulate.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfDeathStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_butcher2.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfDisease]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_plaguecloud.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfFrostStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_empowerruneblade2.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfHeartStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_weapon_shortblade_40.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfHowlingBlast]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_arcticwinds.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfHungeringCold]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_staff_15.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfIceboundFortitude]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_iceboundfortitude.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfIcyTouch]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_icetouch.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfObliterate]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_classicon.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfPlagueStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_empowerruneblade.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfRuneStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_darkconviction.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfRuneTap]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_runetap.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfScourgeStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_scourgestrike.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfStrangulate]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_soulleech_3.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfTheGhoul]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_animatedead.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfUnbreakableArmor]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_armor_helm_plate_naxxramas_raidwarrior_c_01.jpg',
		},
		[DeathknightMajorGlyph.GlyphOfUnholyBlight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_contagion.jpg',
		},
	...
	minorGlyphs: {
		[DeathknightMinorGlyph.GlyphOfBloodTap]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_deathknight_bloodtap.jpg',
		},
		[DeathknightMinorGlyph.GlyphOfCorpseExplosion]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_creature_disease_02.jpg',
		},
		...
		[DeathknightMinorGlyph.GlyphOfHornOfWinter]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_misc_horn_02.jpg',
		},
