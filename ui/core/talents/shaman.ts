...
export const shamanGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[ShamanMajorGlyph.GlyphOfChainHeal]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_healingwavegreater.jpg',
		},
		[ShamanMajorGlyph.GlyphOfChainLightning]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_chainlightning.jpg',
		},
		[ShamanMajorGlyph.GlyphOfEarthShield]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_skinofearth.jpg',
		},
		[ShamanMajorGlyph.GlyphOfEarthlivingWeapon]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shaman_earthlivingweapon.jpg',
		},
		[ShamanMajorGlyph.GlyphOfElementalMastery]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_wispheal.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFeralSpirit]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shaman_feralspirit.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFireElementalTotem]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_elemental_totem.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFireNova]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_sealoffire.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFlameShock]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_flameshock.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFlametongueWeapon]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_flametounge.jpg',
		},
		[ShamanMajorGlyph.GlyphOfFrostShock]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_frostshock.jpg',
		},
		[ShamanMajorGlyph.GlyphOfHealingStreamTotem]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_spear_04.jpg',
		},
		[ShamanMajorGlyph.GlyphOfHealingWave]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_magicimmunity.jpg',
		},
		[ShamanMajorGlyph.GlyphOfHex]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shaman_hex.jpg',
		},
		[ShamanMajorGlyph.GlyphOfLava]: {
			name: 'Glyph of Lava',
			description: 'Your Lava Burst spell gains an additional 10% of your spellpower.',
			iconUrl: '/wotlk/assets/icons/large/spell_shaman_lavaburst.jpg',
		},
		[ShamanMajorGlyph.GlyphOfLavaLash]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_shaman_lavalash.jpg',
		},
		[ShamanMajorGlyph.GlyphOfLesserHealingWave]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_healingwavelesser.jpg',
		},
		...
		[ShamanMajorGlyph.GlyphOfLightningShield]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_lightningshield.jpg',
		},
		...
		[ShamanMajorGlyph.GlyphOfRiptide]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_riptide.jpg',
		},
		[ShamanMajorGlyph.GlyphOfShocking]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_earthshock.jpg',
		},
		...
		[ShamanMajorGlyph.GlyphOfStormstrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_shaman_stormstrike.jpg',
		},
		[ShamanMajorGlyph.GlyphOfThunder]: {
			name: 'Glyph of Thunder',
			description: 'Reduces the cooldown on Thunderstorm by 10 sec.',
			iconUrl: '/wotlk/assets/icons/large/spell_shaman_thunderstorm.jpg',
		},
		[ShamanMajorGlyph.GlyphOfTotemOfWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_fire_totemofwrath.jpg',
		},
		[ShamanMajorGlyph.GlyphOfWaterMastery]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_shaman_watershield.jpg',
		},
	...
	minorGlyphs: {
		[ShamanMinorGlyph.GlyphOfAstralRecall]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_astralrecal.jpg',
		},
		[ShamanMinorGlyph.GlyphOfGhostWolf]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_spiritwolf.jpg',
		},
		...
		[ShamanMinorGlyph.GlyphOfWaterWalking]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_frost_windwalkon.jpg',
		},
	},
};
