...
export const druidGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[DruidMajorGlyph.GlyphOfEntanglingRoots]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_stranglevines.jpg',
		},
		[DruidMajorGlyph.GlyphOfFocus]: {
			name: 'Glyph of Focus',
			description: 'Increases the damage done by Starfall by 10%, but decreases its radius by 50%.',
			iconUrl: '/wotlk/assets/icons/large/ability_druid_starfall.jpg',
		},
		[DruidMajorGlyph.GlyphOfFrenziedRegeneration]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_bullrush.jpg',
		},
		[DruidMajorGlyph.GlyphOfGrowling]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_physical_taunt.jpg',
		},
		[DruidMajorGlyph.GlyphOfHealingTouch]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_healingtouch.jpg',
		},
		[DruidMajorGlyph.GlyphOfHurricane]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_cyclone.jpg',
		},
		[DruidMajorGlyph.GlyphOfInnervate]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_lightning.jpg',
		},
		...
		[DruidMajorGlyph.GlyphOfMoonfire]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_starfall.jpg',
		},
		[DruidMajorGlyph.GlyphOfOmenOfClarity]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_faeriefire.jpg',
		},
		[DruidMajorGlyph.GlyphOfNourish]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_nourish.jpg',
		},
		[DruidMajorGlyph.GlyphOfRake]: {
			name: 'Glyph of Rake',
			description: 'Your Rake ability prevents targets from fleeing.',
			iconUrl: '/wotlk/assets/icons/large/ability_druid_disembowel.jpg',
		},
		[DruidMajorGlyph.GlyphOfRapidRejuvenation]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_rejuvenation.jpg',
		},
		[DruidMajorGlyph.GlyphOfRebirth]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_reincarnation.jpg',
		},
		[DruidMajorGlyph.GlyphOfRegrowth]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_resistnature.jpg',
		},
		...
		[DruidMajorGlyph.GlyphOfRip]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_ghoulfrenzy.jpg',
		},
		[DruidMajorGlyph.GlyphOfSavageRoar]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_skinteeth.jpg',
		},
		[DruidMajorGlyph.GlyphOfShred]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_vampiricaura.jpg',
		},
		...
		[DruidMajorGlyph.GlyphOfStarfire]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_arcane_starfire.jpg',
		},
		[DruidMajorGlyph.GlyphOfSurvivalInstincts]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_tigersroar.jpg',
		},
		[DruidMajorGlyph.GlyphOfSwiftmend]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_relics_idolofrejuvenation.jpg',
		},
		[DruidMajorGlyph.GlyphOfWildGrowth]: {
			name: 'Glyph of Wild Growth',
			description: 'Wild Growth can affect 1 additional target.',
			iconUrl: '/wotlk/assets/icons/large/ability_druid_flourish.jpg',
		},
		[DruidMajorGlyph.GlyphOfWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_abolishmagic.jpg',
		},
	},
	minorGlyphs: {
		[DruidMinorGlyph.GlyphOfAquaticForm]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_aquaticform.jpg',
		},
		[DruidMinorGlyph.GlyphOfChallengingRoar]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_druid_challangingroar.jpg',
		},
		[DruidMinorGlyph.GlyphOfDash]: {
			name: 'Glyph of Dash',
			description: 'Reduces the cooldown of your Dash ability by 20%.',
			iconUrl: '/wotlk/assets/icons/large/ability_druid_dash.jpg',
		},
		[DruidMinorGlyph.GlyphOfTheWild]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_regeneration.jpg',
		},
		[DruidMinorGlyph.GlyphOfThorns]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_thorns.jpg',
		},
