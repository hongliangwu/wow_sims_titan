...
export const priestGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[PriestMajorGlyph.GlyphOfCircleOfHealing]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_circleofrenewal.jpg',
		},
		[PriestMajorGlyph.GlyphOfDispelMagic]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_dispelmagic.jpg',
		},
		[PriestMajorGlyph.GlyphOfDispersion]: {
			name: 'Glyph of Dispersion',
			description: 'Reduces the cooldown on Dispersion by 45 sec.',
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_dispersion.jpg',
		},
		...
		[PriestMajorGlyph.GlyphOfGuardianSpirit]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_guardianspirit.jpg',
		},
		[PriestMajorGlyph.GlyphOfHolyNova]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_holynova.jpg',
		},
		[PriestMajorGlyph.GlyphOfHymnOfHope]: {
			name: 'Glyph of Hymn of Hope',
			description: 'Your Hymn of Hope lasts an additional 2 sec.',
			iconUrl: '/wotlk/assets/icons/large/spell_holy_symbolofhope.jpg',
		},
		...
		[PriestMajorGlyph.GlyphOfLightwell]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_summonlightwell.jpg',
		},
		[PriestMajorGlyph.GlyphOfMassDispel]: {
			name: 'Glyph of Mass Dispel',
			description: 'Reduces the mana cost of Mass Dispel by 35%.',
			iconUrl: '/wotlk/assets/icons/large/spell_arcane_massdispel.jpg',
		},
		...
		[PriestMajorGlyph.GlyphOfMindFlay]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_siphonmana.jpg',
		},
		[PriestMajorGlyph.GlyphOfMindSear]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_mindshear.jpg',
		},
		[PriestMajorGlyph.GlyphOfPainSuppression]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_painsupression.jpg',
		},
		[PriestMajorGlyph.GlyphOfPenance]: {
			name: 'Glyph of Penance',
			description: 'Reduces the cooldown of Penance by 2 sec.',
			iconUrl: '/wotlk/assets/icons/large/spell_holy_penance.jpg',
		},
		[PriestMajorGlyph.GlyphOfPowerWordShield]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_powerwordshield.jpg',
		},
		[PriestMajorGlyph.GlyphOfPrayerOfHealing]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_prayerofhealing02.jpg',
		},
		[PriestMajorGlyph.GlyphOfPsychicScream]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_psychicscream.jpg',
		},
		...
		[PriestMajorGlyph.GlyphOfScourgeImprisonment]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_slow.jpg',
		},
		[PriestMajorGlyph.GlyphOfShadow]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_mindsooth.jpg',
		},
		[PriestMajorGlyph.GlyphOfShadowWordDeath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_demonicfortitude.jpg',
		},
		[PriestMajorGlyph.GlyphOfShadowWordPain]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_shadowwordpain.jpg',
		},
		[PriestMajorGlyph.GlyphOfSmite]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_holysmite.jpg',
		},
		[PriestMajorGlyph.GlyphOfSpiritOfRedemption]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_enchant_essenceeternallarge.jpg',
		},
	},
	minorGlyphs: {
		...
		[PriestMinorGlyph.GlyphOfFortitude]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_wordfortitude.jpg',
		},
		...
		[PriestMinorGlyph.GlyphOfShadowfiend]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_shadow_shadowfiend.jpg',
		},
	},
};
