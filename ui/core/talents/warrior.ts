...
export const warriorGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[WarriorMajorGlyph.GlyphOfBladestorm]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_bladestorm.jpg',
		},
		[WarriorMajorGlyph.GlyphOfBlocking]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_shield_05.jpg',
		},
		...
		[WarriorMajorGlyph.GlyphOfDevastate]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_sword_11.jpg',
		},
		[WarriorMajorGlyph.GlyphOfEnragedRegeneration]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_focusedrage.jpg',
		},
		[WarriorMajorGlyph.GlyphOfExecution]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_sword_48.jpg',
		},
		[WarriorMajorGlyph.GlyphOfHamstring]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_shockwave.jpg',
		},
		...
		[WarriorMajorGlyph.GlyphOfIntervene]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_victoryrush.jpg',
		},
		[WarriorMajorGlyph.GlyphOfLastStand]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_ashestoashes.jpg',
		},
		[WarriorMajorGlyph.GlyphOfMortalStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_savageblow.jpg',
		},
		[WarriorMajorGlyph.GlyphOfOverpower]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_meleedamage.jpg',
		},
		[WarriorMajorGlyph.GlyphOfRapidCharge]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_charge.jpg',
		},
		...
		[WarriorMajorGlyph.GlyphOfResonatingPower]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_nature_thunderclap.jpg',
		},
		[WarriorMajorGlyph.GlyphOfRevenge]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_revenge.jpg',
		},
		[WarriorMajorGlyph.GlyphOfShieldWall]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_shieldwall.jpg',
		},
		[WarriorMajorGlyph.GlyphOfShockwave]: {
			name: 'Glyph of Shockwave',
			description: 'Reduces the cooldown on Shockwave by 3 sec.',
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_shockwave.jpg',
		},
		[WarriorMajorGlyph.GlyphOfSpellReflection]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_shieldreflection.jpg',
		},
		[WarriorMajorGlyph.GlyphOfSunderArmor]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_sunder.jpg',
		},
		...
		[WarriorMajorGlyph.GlyphOfVictoryRush]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_devastate.jpg',
		},
		[WarriorMajorGlyph.GlyphOfVigilance]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_vigilance.jpg',
		},
		[WarriorMajorGlyph.GlyphOfWhirlwind]: {
			name: 'Glyph of Whirlwind',
			description: 'Reduces the cooldown of your Whirlwind by 2 sec.',
			iconUrl: '/wotlk/assets/icons/large/ability_whirlwind.jpg',
		},
	},
	minorGlyphs: {
		[WarriorMinorGlyph.GlyphOfBattle]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_battleshout.jpg',
		},
		[WarriorMinorGlyph.GlyphOfBloodrage]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_racial_bloodrage.jpg',
		},
		...
		[WarriorMinorGlyph.GlyphOfCommand]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_rallyingcry.jpg',
		},
		...
		[WarriorMinorGlyph.GlyphOfShatteringThrow]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_shatteringthrow.jpg',
		},
	},
};
