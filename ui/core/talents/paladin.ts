...
export const paladinGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[PaladinMajorGlyph.GlyphOfAvengerSShield]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_avengersshield.jpg',
		},
		[PaladinMajorGlyph.GlyphOfAvengingWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_avenginewrath.jpg',
		},
		[PaladinMajorGlyph.GlyphOfBeaconOfLight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_paladin_beaconoflight.jpg',
		},
		[PaladinMajorGlyph.GlyphOfCleansing]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_purify.jpg',
		},
		[PaladinMajorGlyph.GlyphOfConsecration]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_innerfire.jpg',
		},
		[PaladinMajorGlyph.GlyphOfCrusaderStrike]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_crusaderstrike.jpg',
		},
		[PaladinMajorGlyph.GlyphOfDivinePlea]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_aspiration.jpg',
		},
		[PaladinMajorGlyph.GlyphOfDivineStorm]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_paladin_divinestorm.jpg',
		},
		[PaladinMajorGlyph.GlyphOfDivinity]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_layonhands.jpg',
		},
		...
		[PaladinMajorGlyph.GlyphOfFlashOfLight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_flashheal.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHammerOfJustice]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_sealofmight.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHammerOfTheRighteous]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_paladin_hammeroftherighteous.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHammerOfWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_thunderclap.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHolyLight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_holybolt.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHolyShock]: {
			name: 'Glyph of Holy Shock',
			description: 'Reduces the cooldown of Holy Shock by 1 sec.',
			iconUrl: '/wotlk/assets/icons/large/spell_holy_searinglight.jpg',
		},
		[PaladinMajorGlyph.GlyphOfHolyWrath]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_excorcism.jpg',
		},
		[PaladinMajorGlyph.GlyphOfJudgement]: {
			name: 'Glyph of Judgement',
			description: 'Your Judgements deal 10% more damage.',
			iconUrl: '/wotlk/assets/icons/large/ability_paladin_judgementred.jpg',
		},
		[PaladinMajorGlyph.GlyphOfRighteousDefense]: {
			...
			iconUrl: '/wotlk/assets/icons/large/inv_shoulder_37.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSalvation]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_sealofsalvation.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSealOfCommand]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_warrior_innerrage.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSealOfLight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_healingaura.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSealOfRighteousness]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_thunderbolt.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSealOfVengeance]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_sealofvengeance.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSealOfWisdom]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_righteousnessaura.jpg',
		},
		[PaladinMajorGlyph.GlyphOfShieldOfRighteousness]: {
			...
			iconUrl: '/wotlk/assets/icons/large/ability_paladin_shieldofvengeance.jpg',
		},
		[PaladinMajorGlyph.GlyphOfSpiritualAttunement]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_revivechampion.jpg',
		},
		[PaladinMajorGlyph.GlyphOfTurnEvil]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_turnundead.jpg',
		},
		[PaladinMajorGlyph.GlyphOfReckoning]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_unyieldingfaith.jpg',
		},
	},
	minorGlyphs: {
		[PaladinMinorGlyph.GlyphOfBlessingOfKings]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_magic_magearmor.jpg',
		},
		[PaladinMinorGlyph.GlyphOfBlessingOfMight]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_fistofjustice.jpg',
		},
		[PaladinMinorGlyph.GlyphOfBlessingOfWisdom]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_sealofwisdom.jpg',
		},
		...
		[PaladinMinorGlyph.GlyphOfSenseUndead]: {
			...
			iconUrl: '/wotlk/assets/icons/large/spell_holy_senseundead.jpg',
		},
