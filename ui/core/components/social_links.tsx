	...
	static buildDiscordLink(): Element {
		const anchor = (
			<a
				...
				dataset={{ bsToggle: 'tooltip', bsTitle: t('Join us on Discord') }}>
	...
	static buildGitHubLink(): Element {
		const anchor = (
			<a
				...
				dataset={{ bsToggle: 'tooltip', bsTitle: t('Contribute on GitHub') }}>
	...
	static buildPatreonLink(): Element {
		const anchor = (
			<a
				...
				dataset={{ bsToggle: 'tooltip', bsTitle: t('Support us on Patreon') }}>
